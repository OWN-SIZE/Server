...
const saveBest = async (
    ...
    if (topOrBottom===0) {
        ...
        const firTS = resultAbsTS.sort(function (a, b) { return a - b;})[0];
        const secTS = resultAbsTS.sort(function (a, b) { return a - b;})[1];
        ...
        const firTC = resultAbsTC.sort(function (a, b) { return a - b;})[0];
        const secTC = resultAbsTC.sort(function (a, b) { return a - b;})[1];
        ...
        return data;
         ...
         for (var i = 0; i < BottomLength.length; i++) {
            resultBL.push(Math.abs(Number(BottomLength[i])-Number(MyBottomArr[0][0])));
            resultBW.push(Math.abs(Number(BottomWaist[i])-Number(MyBottomArr[0][1])));
            resultBT.push(Math.abs(Number(BottomThigh[i])-Number(MyBottomArr[0][2])));
            resultBR.push(Math.abs(Number(BottomRise[i])-Number(MyBottomArr[0][3])));
        ...
        const firBL = resultAbsBL.sort(function (a, b) { return a - b;})[0];
        const secBL = resultAbsBL.sort(function (a, b) { return a - b;})[1];
        ...
        const firBW = resultAbsBW.sort(function (a, b) { return a - b;})[0];
        const secBW = resultAbsBW.sort(function (a, b) { return a - b;})[1];
        ...
        const firBT = resultAbsBT.sort(function (a, b) { return a - b;})[0];
        const secBT = resultAbsBT.sort(function (a, b) { return a - b;})[1];
        ...
        const firBR = resultAbsBR.sort(function (a, b) { return a - b;})[0];
        const secBR = resultAbsBR.sort(function (a, b) { return a - b;})[1];
        ...
        const firBH = resultAbsBH.sort(function (a, b) { return a - b;})[0];
        const secBH = resultAbsBH.sort(function (a, b) { return a - b;})[1];
